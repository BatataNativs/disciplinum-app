...
part of 'reading_book_entity.dart';
...
extension GetReadingBookEntityCollection on Isar {
  IsarCollection<ReadingBookEntity> get readingBookEntitys => this.collection();
}

const ReadingBookEntitySchema = CollectionSchema(
  name: r'ReadingBookEntity',
  id: -5952423482366384674,
  properties: {
    ...
    r'theme': PropertySchema(
      ...
      name: r'theme',
      type: IsarType.byte,
      enumMap: _ReadingBookEntitythemeEnumValueMap,
    ),
  ...
  estimateSize: _readingBookEntityEstimateSize,
  serialize: _readingBookEntitySerialize,
  deserialize: _readingBookEntityDeserialize,
  deserializeProp: _readingBookEntityDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _readingBookEntityGetId,
  getLinks: _readingBookEntityGetLinks,
  attach: _readingBookEntityAttach,
  version: '3.1.0+1',
);

int _readingBookEntityEstimateSize(
  ReadingBookEntity object,
  List<int> offsets,
...
void _readingBookEntitySerialize(
  ReadingBookEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
ReadingBookEntity _readingBookEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _readingBookEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
  ...
  switch (propertyId) {
    ...
    case 14:
      return (reader.readDateTimeOrNull(offset)) as P;
    case 15:
      return (_ReadingBookEntitythemeValueEnumMap[
              reader.readByteOrNull(offset)] ??
          ReadingTheme.ficcaoCientifica) as P;
    case 16:
      return (reader.readString(offset)) as P;
    case 17:
      return (reader.readLong(offset)) as P;
...
const _ReadingBookEntitythemeEnumValueMap = {
  'ficcaoCientifica': 0,
  'terrorMisterio': 1,
  'romance': 2,
  'suspenseThriller': 3,
  'policialInvestigacao': 4,
  'trueCrime': 5,
  'fantasia': 6,
  'aventura': 7,
  'guerraMilitar': 8,
  'biografiaAutobiografia': 9,
  'autoajuda': 10,
  'outros': 11,
};
const _ReadingBookEntitythemeValueEnumMap = {
  0: ReadingTheme.ficcaoCientifica,
  1: ReadingTheme.terrorMisterio,
  2: ReadingTheme.romance,
  3: ReadingTheme.suspenseThriller,
  4: ReadingTheme.policialInvestigacao,
  5: ReadingTheme.trueCrime,
  6: ReadingTheme.fantasia,
  7: ReadingTheme.aventura,
  8: ReadingTheme.guerraMilitar,
  9: ReadingTheme.biografiaAutobiografia,
  10: ReadingTheme.autoajuda,
  11: ReadingTheme.outros,
};

Id _readingBookEntityGetId(ReadingBookEntity object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _readingBookEntityGetLinks(
    ReadingBookEntity object) {
  return [];
}

void _readingBookEntityAttach(
    IsarCollection<dynamic> col, Id id, ReadingBookEntity object) {
  object.id = id;
}

extension ReadingBookEntityQueryWhereSort
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QWhere> {
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterWhere> anyId() {
...
extension ReadingBookEntityQueryWhere
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QWhereClause> {
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterWhereClause>
      idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
...
extension ReadingBookEntityQueryFilter
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QFilterCondition> {
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterFilterCondition>
  ...
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterFilterCondition>
      themeEqualTo(ReadingTheme value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'theme',
        value: value,
...
extension ReadingBookEntityQueryObject
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QFilterCondition> {}

extension ReadingBookEntityQueryLinks
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QFilterCondition> {}

extension ReadingBookEntityQuerySortBy
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QSortBy> {
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterSortBy>
...
extension ReadingBookEntityQuerySortThenBy
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QSortThenBy> {
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterSortBy>
  ...
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
...
extension ReadingBookEntityQueryWhereDistinct
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QDistinct> {
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QDistinct>
  ...
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QDistinct> distinctByNotes(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingBookEntity, ReadingBookEntity, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ReadingBookEntityQueryProperty
    on QueryBuilder<ReadingBookEntity, ReadingBookEntity, QQueryProperty> {
  QueryBuilder<ReadingBookEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<ReadingBookEntity, String?, QQueryOperations>
  ...
  QueryBuilder<ReadingBookEntity, String, QQueryOperations> authorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'author');
    });
  }

  QueryBuilder<ReadingBookEntity, DateTime?, QQueryOperations>
  ...
  QueryBuilder<ReadingBookEntity, int, QQueryOperations> currentPageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currentPage');
    });
  }

  QueryBuilder<ReadingBookEntity, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hashCode');
    });
  }

  QueryBuilder<ReadingBookEntity, bool, QQueryOperations>
      isCompletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingBookEntity, bool, QQueryOperations> isStartedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isStarted');
    });
  }

  QueryBuilder<ReadingBookEntity, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<ReadingBookEntity, double, QQueryOperations> progressProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'progress');
    });
  }

  QueryBuilder<ReadingBookEntity, double, QQueryOperations>
  ...
  QueryBuilder<ReadingBookEntity, int?, QQueryOperations> ratingProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingBookEntity, ReadingTheme, QQueryOperations>
      themeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingBookEntity, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'title');
    });
  }

  QueryBuilder<ReadingBookEntity, int, QQueryOperations> totalPagesProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingBookEntity, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
