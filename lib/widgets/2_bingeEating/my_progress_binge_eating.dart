...
class MyProgressBingeEating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isActive = gamification.isModuleActive(NicheId.bingeEating);

    return Scaffold(
      appBar: AppBar(
        title: const Text('Compulsão Alimentar'),
        centerTitle: true,
              ...
              children: [
                NeonCard(
                  ...
                  child: Column(
                    children: [
                      Image.asset(
                        'assets/icons/niche_compulsao.png',
                        height: 64,
                      ),
                      const SizedBox(height: 16),
                      Text(
                        isActive
                            ? '$dias dias de controle'
                            : 'Módulo desativado',
                        style: TextStyle(
                          fontSize: 24,
