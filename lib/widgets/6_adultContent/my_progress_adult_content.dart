...
class MyProgressAdultContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isActive = gamification.isModuleActive(NicheId.adultContent);

    return Scaffold(
      appBar: AppBar(
        title: const Text('Conteúdo Adulto'),
        centerTitle: true,
              ...
              children: [
                NeonCard(
                  ...
                  child: Column(
                    children: [
                      Image.asset(
                        'assets/icons/niche_adult_content.png',
                        height: 64,
                      ),
                      const SizedBox(height: 16),
                      Text(
                        isActive
                            ? '$dias dias sem acessar'
                            : 'Módulo desativado',
                        style: TextStyle(
                          fontSize: 24,
