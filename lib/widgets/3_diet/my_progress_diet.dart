...
class MyProgressDiet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dias = gamification.diasConsecutivosByModule[NicheId.diet] ?? 0;
    final isActive = gamification.isModuleActive(NicheId.diet);
              ...
              children: [
                NeonCard(
                  ...
                  child: Column(
                    children: [
                      Image.asset(
                        'assets/icons/niche_dieta.png',
                        height: 64,
                      ),
                      const SizedBox(height: 16),
                      Text(
                        isActive ? '$dias dias na dieta' : 'Módulo desativado',
                        style: TextStyle(
                          fontSize: 24,
