...
/// Verificador de migrações do Supabase para Binge Eating Gamification
/// Garante que a tabela e políticas existam antes de usar
class BingeEatingMigrationChecker {
  static BingeEatingMigrationChecker? _instance;
  static BingeEatingMigrationChecker get instance => _instance ??= BingeEatingMigrationChecker._();
  
  BingeEatingMigrationChecker._();

  /// Verifica se a tabela binge_eating_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela binge_eating_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Binge Eating', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela binge_eating_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 003_create_binge_eating_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Binge Eating pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Binge Eating OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Binge Eating', error: e);
      return false;
    }
  }
