...
class SmokingMigrationChecker {
  static SmokingMigrationChecker? _instance;
  static SmokingMigrationChecker get instance => _instance ??= SmokingMigrationChecker._();
  
  SmokingMigrationChecker._();
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Smoking', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        ...
        LoggerService.instance.i('📋 Execute a migration SQL: 001_create_smoking_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Smoking pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Smoking OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Smoking', error: e);
      return false;
    }
  }
