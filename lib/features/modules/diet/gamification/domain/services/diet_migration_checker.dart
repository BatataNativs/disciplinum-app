...
/// Verificador de migrações do Supabase para Diet Gamification
/// Garante que a tabela e políticas existam antes de usar
class DietMigrationChecker {
  static DietMigrationChecker? _instance;
  static DietMigrationChecker get instance => _instance ??= DietMigrationChecker._();
  
  DietMigrationChecker._();

  /// Verifica se a tabela diet_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela diet_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Diet', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela diet_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 004_create_diet_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Diet pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Diet OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Diet', error: e);
      return false;
    }
  }
