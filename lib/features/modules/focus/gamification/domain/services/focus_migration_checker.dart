...
/// Verificador de migrações do Supabase para Focus Gamification
/// Garante que a tabela e políticas existam antes de usar
class FocusMigrationChecker {
  static FocusMigrationChecker? _instance;
  static FocusMigrationChecker get instance => _instance ??= FocusMigrationChecker._();
  
  FocusMigrationChecker._();

  /// Verifica se a tabela focus_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela focus_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Focus', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela focus_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 002_create_focus_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Focus pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Focus OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Focus', error: e);
      return false;
    }
  }
