...
import 'package:disciplinum/features/modules/procrastination/gamification/domain/entities/procrastination_insignia.dart';
import 'package:disciplinum/features/modules/procrastination/gamification/domain/entities/procrastination_medal.dart';

class MyProgressProcrastination extends ConsumerWidget {
  const MyProgressProcrastination({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dias = ref.watch(procrastinationStreakProvider);
    final disciplinumCount = ref.watch(procrastinationDisciplinumCountProvider);
    final earnedInsignias = ref.watch(procrastinationInsigniasProvider);
    final earnedMedalhas = ref.watch(procrastinationMedalhasProvider);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Seu progresso no módulo: Evitar Procrastinação',
            ...
            const SizedBox(height: 4),
            const Text(
              'Conquistas por dias de produtividade',
            ...
            Container(
              ...
              child: GridView.count(
                ...
                children: ProcrastinationInsigniaEntity.values.map((insignia) {
            ...
            Container(
              ...
              child: GridView.count(
                ...
                children: ProcrastinationMedalEntity.values.map((medal) {
