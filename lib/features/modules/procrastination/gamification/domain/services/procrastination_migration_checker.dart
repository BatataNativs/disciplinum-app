...
/// Verificador de migrações do Supabase para Procrastination Gamification
/// Garante que a tabela e políticas existam antes de usar
class ProcrastinationMigrationChecker {
  static ProcrastinationMigrationChecker? _instance;
  static ProcrastinationMigrationChecker get instance => _instance ??= ProcrastinationMigrationChecker._();
  
  ProcrastinationMigrationChecker._();

  /// Verifica se a tabela procrastination_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela procrastination_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Procrastination', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela procrastination_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 007_create_procrastination_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Procrastination pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Procrastination OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Procrastination', error: e);
      return false;
    }
  }
