...
/// Verificador de migrações do Supabase para Money Saving Gamification
/// Garante que a tabela e políticas existam antes de usar
class MoneySavingMigrationChecker {
  static MoneySavingMigrationChecker? _instance;
  static MoneySavingMigrationChecker get instance => _instance ??= MoneySavingMigrationChecker._();
  
  MoneySavingMigrationChecker._();

  /// Verifica se a tabela money_saving_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela money_saving_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Money Saving', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela money_saving_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 005_create_money_saving_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Money Saving pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Money Saving OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Money Saving', error: e);
      return false;
    }
  }
