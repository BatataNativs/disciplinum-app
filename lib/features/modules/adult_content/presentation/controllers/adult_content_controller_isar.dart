...
/// Controller Riverpod para Adult Content usando Isar puro
class AdultContentControllerIsar extends StateNotifier<AdultContentState> {
  final AdultContentServiceIsar _service;
  
  AdultContentControllerIsar(this._service) : super(const AdultContentState()) {
    _loadData();
  }
