...
/// Verificador de migrações do Supabase para Adult Content Gamification
/// Garante que a tabela e políticas existam antes de usar
class AdultContentMigrationChecker {
  static AdultContentMigrationChecker? _instance;
  static AdultContentMigrationChecker get instance => _instance ??= AdultContentMigrationChecker._();
  
  AdultContentMigrationChecker._();

  /// Verifica se a tabela adult_content_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela adult_content_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Adult Content', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela adult_content_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 002_create_adult_content_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Adult Content pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Adult Content OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Adult Content', error: e);
      return false;
    }
  }
