...
/// Verificador de migrações do Supabase para Reading Gamification
/// Garante que a tabela e políticas existam antes de usar
class ReadingMigrationChecker {
  static ReadingMigrationChecker? _instance;
  static ReadingMigrationChecker get instance => _instance ??= ReadingMigrationChecker._();
  
  ReadingMigrationChecker._();

  /// Verifica se a tabela reading_gamification_states existe
  Future<bool> _checkTableExists() async {
    try {
      ...
      LoggerService.instance.e('Tabela reading_gamification_states não encontrada', error: e);
      return false;
    }
  }
  ...
  Future<MigrationStatus> checkMigrationStatus() async {
    try {
      ...
      LoggerService.instance.e('Erro ao verificar migração Reading', error: e);
  ...
  Future<bool> ensureMigration() async {
    ...
    switch (status) {
      case MigrationStatus.tableMissing:
        LoggerService.instance.e('❌ Tabela reading_gamification_states não existe');
        LoggerService.instance.i('📋 Execute a migration SQL: 009_create_reading_gamification_states.sql');
      ...
      case MigrationStatus.complete:
        LoggerService.instance.i('✅ Supabase Reading pronto para uso');
        return true;
  ...
  Future<bool> testFullConnection() async {
    try {
      ...
      LoggerService.instance.i('✅ Teste completo do Supabase Reading OK');
      return true;
    } catch (e) {
      LoggerService.instance.e('Erro no teste completo do Supabase Reading', error: e);
      return false;
    }
  }
