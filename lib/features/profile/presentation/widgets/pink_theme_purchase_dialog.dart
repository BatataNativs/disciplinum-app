...
class PinkThemePurchaseDialog extends ConsumerStatefulWidget {
  const PinkThemePurchaseDialog({super.key});

  @override
  ConsumerState<PinkThemePurchaseDialog> createState() => _PinkThemePurchaseDialogState();
}

class _PinkThemePurchaseDialogState extends ConsumerState<PinkThemePurchaseDialog> {
  Timer? _errorTimeout;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _iapService?.onPurchaseResult = (productId, success) {
        ...
        if (success) {
          EnhancedSnackBarHelper.showSuccess(context, 'Tema Rosa desbloqueado com sucesso!');
        } else {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Personalize seu app com um tema rosa vibrante e elegante',
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      EnhancedSnackBarHelper.showInfo(context, 'Iniciando compra do Tema Rosa...');
                      ...
                      // Executa a compra
                      iapService.buyByProductId(IapService.productIdPinkTheme);
                    },
