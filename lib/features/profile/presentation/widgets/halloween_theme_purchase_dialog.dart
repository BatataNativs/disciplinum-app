...
class HalloweenThemePurchaseDialog extends ConsumerStatefulWidget {
  const HalloweenThemePurchaseDialog({super.key});

  @override
  ConsumerState<HalloweenThemePurchaseDialog> createState() => _HalloweenThemePurchaseDialogState();
}

class _HalloweenThemePurchaseDialogState extends ConsumerState<HalloweenThemePurchaseDialog> {
  Timer? _errorTimeout;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _iapService?.onPurchaseResult = (productId, success) {
        ...
        if (success) {
          EnhancedSnackBarHelper.showSuccess(context, 'Tema Halloween desbloqueado com sucesso!');
        } else {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Transforme seu app com um tema assustadoramente divertido',
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      EnhancedSnackBarHelper.showInfo(context, 'Iniciando compra do Tema Halloween...');
                      ...
                      // Executa a compra
                      iapService.buyByProductId(IapService.productIdHalloweenTheme);
                    },
